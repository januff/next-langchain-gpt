...
export const Book: FC = () => {
  return (
    <div className="flex h-[300px] items-center justify-center">
      <div className="flex flex-col text-left ml-3 max-w-[250px]">
          <h1 className="text-4xl font-bold">Impromptu</h1>
          <h2 className="text-sm font-medium tracking-tight mt-2">Amplifying Our Humanity Through AI</h2>
          <span className="my-1 mt-3 text-xs font-semibold">A new book by Reid Hoffman, with GPT-4.</span>
          <span className="my-1 text-xs font-semibold">In the past, you actually had to read books. Now, you can simply ask them questions. Try it out!</span>
